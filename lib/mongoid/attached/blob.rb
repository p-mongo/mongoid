...
module ActiveStorage::Blob::Representable
  ...
  included do
    ...
    embeds_one_attached :preview_image
  end
...
class Mongoid::Attached::Blob
  ...
  after_initialize do
    ...
    self.service_name = 'fill-in-service'
  end

  #after_update_commit :update_service_metadata, if: :content_type_previously_changed?
  after_update :update_service_metadata, if: :content_type_previously_changed?
...
ActiveSupport.run_load_hooks :active_storage_blob, Mongoid::Attached::Blob

Blob = Mongoid::Attached::Blob
